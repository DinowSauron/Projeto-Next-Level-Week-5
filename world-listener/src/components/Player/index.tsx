        ...
        <div className={styles.playerContainer}>
            ...
            <footer className={!episode ? styles.empty : ""}>
                <div className={styles.progress}>
                    <span>{convertSecondsToTime(progress)}</span>
                    ...
                    <span>{convertSecondsToTime(episode?.duration ?? 0)}</span>
                </div>
                ...
                <div className={styles.buttons}>
                    ...
                    <button type="button" disabled={(!episode || !hasPlayerDirection("previous") && !isShuffling)} onClick={() => playStep("previous")}>
                    ...
                    <button type="button" disabled={(!episode || !hasPlayerDirection("next") && !isShuffling)} onClick={() => playStep("next")}>
